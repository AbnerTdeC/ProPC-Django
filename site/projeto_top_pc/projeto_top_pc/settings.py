"""
Django settings for projeto_top_pc project.
...
SECRET_KEY = 'django-insecure-$@=jghed8!l-rfi@pvdjpy)g_)l9w^e3g=li#swf*kah(9l9pc'
...
ROOT_URLCONF = 'projeto_top_pc.urls'
...
WSGI_APPLICATION = 'projeto_top_pc.wsgi.application'
